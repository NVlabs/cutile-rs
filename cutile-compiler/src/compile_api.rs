...
use cutile_frontend::compiler::{CUDATileFunctionCompiler, CUDATileModules};
use cutile_frontend::error::JITError;
use cutile_frontend::hints::CompileOptions;
use cutile_frontend::specialization::{DivHint, SpecializationBits};
...
///     .compile()?;
/// ```
pub struct KernelCompiler<F: Fn() -> cutile_frontend::ast::Module> {
    module_ast_fn: F,
    module_name: String,
...
impl<F: Fn() -> cutile_frontend::ast::Module> KernelCompiler<F> {
