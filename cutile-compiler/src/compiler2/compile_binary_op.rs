...
use super::value::{CompilerContext, TileRustValue};
...
use tile_ir::ir::{
    Attribute, BlockId, Module, ScalarType, TileElementType, TileType, Type,
};
            ...
            "i1" | "i4" | "i8" | "i32" | "i64" => {
                    ...
                    get_cmp_predicate_attr_ir(tile_rust_arithmetic_op)?
                {
                    ...
                    match tile_rust_arithmetic_op {
                        ...
                        TileBinaryOp::BitAnd => OpBuilder::new(Opcode::AndI, self.ir_location(span))
                            .operand(lhs_value)
                            .operand(rhs_value)
                            .result(operand_result_ty.clone())
                            .build(module),
                        TileBinaryOp::BitOr => OpBuilder::new(Opcode::OrI, self.ir_location(span))
                            ...
                            .result(operand_result_ty.clone())
                            .build(module),
                        TileBinaryOp::BitXor => OpBuilder::new(Opcode::XOrI, self.ir_location(span))
                            .operand(lhs_value)
                            .operand(rhs_value)
                            .result(operand_result_ty.clone())
                            .build(module),
