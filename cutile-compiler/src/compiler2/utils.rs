...
//! Compiler2 utility functions: tile-ir attribute builders.

use tile_ir::ir::Attribute;
...
pub fn type_attr(name: &str, ty: tile_ir::ir::Type) -> NamedAttr {
...
pub fn float_attr(name: &str, value: f64) -> NamedAttr {
    (
        name.to_string(),
        Attribute::float(value, tile_ir::ir::ScalarType::F64),
    )
}
